...
from ncell.api.serializers.credential_serailizer import CredentialSerializer


class NcellTransaction(models.Model, Transaction):
...
class NcellCredential(models.Model):
    app = models.ForeignKey(App, on_delete=models.RESTRICT)
